...
list_of_values = [2, 3.5, 0, 9223372036854775807 ** 10, 4345, 2.5 ** 14, -3, -125.1244]
print(list_of_values)
mixed_list = [1, 2, "why are mixed lists a thing?", 3.0, "hey, we don't have objects implementing classes like in "
                                                         "java, so this is fine"]
